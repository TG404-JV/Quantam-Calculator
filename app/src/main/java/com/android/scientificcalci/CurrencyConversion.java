...
public class CurrencyConversion {
    ...
    public static void convertInBackground(double amount, String fromCurrency, String toCurrency, ConversionListener listener) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.CUPCAKE) {
            new ConversionTask(amount, fromCurrency, toCurrency, listener).execute();
        }
    }

    @RequiresApi(api = Build.VERSION_CODES.CUPCAKE)
    static class ConversionTask extends AsyncTask<Void, Void, Double> {
        ...
        public ConversionTask(double amount, String fromCurrency, String toCurrency, ConversionListener listener) {
            this.amount = amount;
